...
namespace EmguCVLibrary.Theories
{
    ...
    /// Dilate 膨胀
    /// </summary>
    public partial class Erode : ProjectBaseMethod
    {
        #region 构造函数
        public Erode()
        {
        ...
        public Erode(IContainer container)
        {
            container.Add(this);
        ...
        {
            Erode_Para Para = new Erode_Para();
            Para = JsonConvert.DeserializeObject<Erode_Para>(Params);//将字符串转换为参数变量
            //变量赋值
            EShape = Para.EShape;
            Esize = Para.Esize;
        ...
        public override void ProcessImge(ref ImgDataStruct ImgData)
        {
            ...
            //Dilate
            CvInvoke.Erode(ImgData.DstImage, ImgData.DstImage, Element,Anchor, Iterations, BType, BValue);
            //释放卷积核
            Element.Dispose();
            //Gc回收
            GC.Collect();
